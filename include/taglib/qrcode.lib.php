...
function lib_qrcode(&$ctag,&$refObj)
{
    ...
    $reval=<<<EOT
  <a href='http://2v.suncms.com/' id='__sunqrcode_{$GLOBALS['qrcode_id']}'>二维码生成器</a>
  <script type="text/javascript">
  	var __sunqrcode_id={$GLOBALS['qrcode_id']};
  	var __sunqrcode_aid={$id};
  	var __sunqrcode_type='{$type}';
  	var __sunqrcode_dir='{$GLOBALS['cfg_plus_dir']}';
  </script>
